<template>
  ...
  <article class="content-center nav-content ">
    ...
    <p>This personal homepage is built by <icon-link src="https://cn.vuejs.org/">Vue3</icon-link> and
      <icon-link src="https://cn.vuejs.org/">Vite</icon-link>,
      ...
      if you want to see the code click <icon-link icon="Github-icon"
        src="https://github.com/Gary-Leee/v3-vite-ts-blog"></icon-link> or <icon-link icon="Gitee-icon"
        src="https://gitee.com/gary-leee/v3-blog"></icon-link>
    </p>
    <p ref="iconRef">Find me on</p>
    <p class="find-list">
      <icon-link src="https://github.com/Gary-Leee" icon="Github-icon">GitHub</icon-link>
      <icon-link icon="Emial-icon">Emial</icon-link>
      <icon-link src="https://gitee.com/gary-leee" icon="Gitee-icon">Gitee</icon-link>
    </p>
